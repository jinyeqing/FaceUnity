...
import views.effects.beauty.BeautyOptionConfig;
import views.effects.beauty.BeautyOptionItem;
import views.effects.beauty.BeautyOptionListAdapter;
import views.effects.filter.FilterListAdapter;
import views.effects.makeup.MakeupManager;
import views.effects.makeup.MakeupOptionLayout;
import views.effects.sticker.StickerItemListAdapter;
...
public class EffectOptionsLayout extends LinearLayout
    ...
    private OnSenseTimeEffectListener mListener;

    public void setOnBeautyParamSelectedListener(
            OnSenseTimeEffectListener listener) {
        mListener = listener;
    }
    ...
    private void initGroupLayout(Context context) {
        ...
        addView(mGroupLayout, LinearLayout.LayoutParams.MATCH_PARENT, mGroupLayoutHeight);
    ...
    private void initOptionListLayout(Context context) {
        ...
        addView(mOptionListLayout, LinearLayout.LayoutParams.MATCH_PARENT, mOptionListLayoutHeight);
    ...
    public void onMakeupSelected(int group, int type, String path) {
        if (mListener != null) {
            mListener.onMakeupSelected(group, type, path);
        }
    }
    ...
    public void onMakeupRemoved(int group) {
        if (mListener != null) {
            mListener.onMakeupSelected(group,
                    MakeupManager.indexToMakeupType(group), null);
        }
    }
